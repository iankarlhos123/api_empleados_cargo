...
Nota: `DB_USERNAME` y `DB_PASSWORD` dependen de la configuración de tu motor de base de datos. 
...
Antes de consumir cualquier endpoint debes iniciar sesión para obtener tu token abre .
